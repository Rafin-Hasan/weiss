...
const PartThree = () => {
  return (
    <section className="container ">
      <div className="w-full h-screen backgroundPhoto ">
        <div className=" pt-[100px] pl-[120px] font-bold  ">
          <h1 className="text-[14px] text-[#929A9F] ">UNSERE FIRMENHISTORIE</h1>

          <p className="text-[32px] w-[494px] text-white my-[24px] ">
            Diplom-Ingenieur Dieter Weiss gründete im Jahre 1971 sein
            Ingenieurbüro.
          </p>

          <p className="text-[16px] font-medium text-[#FFFFFF] w-[422px] mb-[24px] ">
